...
export const DOCUMENT_CLOSING = {
  instruction:
    'Die vorbezeichneten Unterlagen bitte ich an mich per E-Mail oder auf dem Postweg zu übersenden.',
...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  {
    ...
    items: [
      ...
      'Ihre zuletzt ergangenen Renteninformationen Ihrer gesetzlichen Rentenversicherung',
  ...
  },
  {
    ...
    items: [
      'Personalausweise (falls verheiratet: von beiden Interessenten)',
      'die letzten 3 Gehaltsnachweise (falls verheiratet: von beiden Interessenten)',
